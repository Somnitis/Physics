	...
	const Vector4& color)
{
	...
	if (physics_enabled)
	{
		...
		float dim = halfdims.x*halfdims.x + halfdims.y*halfdims.y + halfdims.z + halfdims.z;
		float spherecollisionradius = sqrt(dim);
		pnode->SetSphereRadius(spherecollisionradius);
	}
