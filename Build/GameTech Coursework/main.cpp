...
void Initialize()
{
	...
	SceneManager::Instance()->EnqueueScene(new PendantScene("GameTech #2 - A Soft Body Scene"));
	SceneManager::Instance()->EnqueueScene(new EmptyScene("GameTech #3 - Pool"));
	SceneManager::Instance()->EnqueueScene(new TargetScene("GameTech #4 - Targets"));
}
...
void HandleKeyboardInputs()
{
	...
	//if (Window::GetKeyboard()->KeyTriggered(KEYBOARD_N) && !inNetwork) {
